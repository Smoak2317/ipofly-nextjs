    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-950 dark:via-purple-950 dark:to-pink-950">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        <div className="text-center">
          {/* Live Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full text-white text-xs sm:text-sm font-bold mb-4 sm:mb-6 border border-white/20 shadow-lg animate-fade-in hover:scale-105 transition-transform cursor-default">
          ...
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 sm:mb-5 leading-tight animate-slide-up">
            Track{' '}
          ...
          {/* Subheading */}
          <p className="text-sm sm:text-base md:text-xl text-white/90 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed animate-slide-up animation-delay-200 font-medium px-4">
          ...
          <div className="grid grid-cols-2 sm:flex gap-3 sm:gap-4 justify-center items-center animate-slide-up animation-delay-400 px-4">
            <a
              href="#ipos"
              className="group relative inline-flex items-center justify-center gap-2 px-4 sm:px-8 py-3 sm:py-4 bg-white text-indigo-600 font-bold rounded-xl hover:bg-gray-50 transition-all transform hover:scale-105 shadow-2xl hover:shadow-indigo-500/50 overflow-hidden text-xs sm:text-base"
            >
              ...
              <svg className="w-4 h-4 sm:w-6 sm:h-6 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="/ongoing"
              className="group inline-flex items-center justify-center gap-2 px-4 sm:px-8 py-3 sm:py-4 bg-white/10 backdrop-blur-md text-white font-bold rounded-xl hover:bg-white/20 transition-all border-2 border-white/20 hover:border-white/40 shadow-xl text-xs sm:text-base"
            >
              <span className="relative flex h-3 w-3">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-green-400"></span>
              </span>
              <span className="hidden sm:inline">View Live IPOs</span>
              <span className="sm:hidden">Live IPOs</span>
            </a>
          </div>
        </div>
      </div>
