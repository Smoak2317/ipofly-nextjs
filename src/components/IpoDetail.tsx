...
export default function IpoDetail({ ipo }: IpoDetailProps) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
          <nav className="flex overflow-x-auto px-8" aria-label="Tabs">
            {["overview", "subscription", "allotment", "company"].map((tab) => (
              <button
                key={tab}
        ...
        <div className="p-8">
          ...
          {activeTab === "allotment" && (
            <div className="space-y-8">
              <div className="text-center bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-12">
