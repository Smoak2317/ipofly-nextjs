// src/components/Footer.tsx - MOBILE OPTIMIZED
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12">
        ...
        <div className="md:hidden mb-6">
          ...
          <div className="flex justify-center gap-4 mb-4">
            <a href="mailto:support@ipofly.com" className="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors">
