      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2 flex-1 justify-center">
            <Link
              href="/mainboard"
              className="px-5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-xl transition-all"
            >
              Mainboard
            </Link>
            <Link
            ...
            <Link
              href="/ongoing"
              className="relative px-5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-xl transition-all"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block">
              <Suspense fallback={
                <div className="w-64 h-10 bg-gray-100 dark:bg-gray-800 rounded-xl animate-pulse" />
              }>
                <SearchBar />
              </Suspense>
            </div>
